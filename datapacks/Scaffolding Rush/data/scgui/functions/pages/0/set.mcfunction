...
item replace entity @s enderchest.2 with stone_sword{scgui:1, scgui.action:1, display:{Name:'[{"text":"Preset :","italic":false,"color":"gold"},{"text":" xxxxxx","italic":false,"color":"gold"}]',Lore:['[{"text":"\\u2666","italic":false,"color":"gold"},{"text":" Vitesse de lave : ","color":"gray"},{"text":"7s"},{"text":"","color":"dark_purple"}]','[{"text":"[...]","italic":false,"color":"white"}]']}} 1
item replace entity @s enderchest.3 with white_banner{scgui:1, scgui.action:1, display:{Name:'[{"text":"Preset :","italic":false,"color":"gold"},{"text":" xxxxxx","italic":false,"color":"gold"}]',Lore:['[{"text":"\\u2666","italic":false,"color":"gold"},{"text":" Vitesse de lave : ","color":"gray"},{"text":"7s"},{"text":"","color":"dark_purple"}]','[{"text":"[...]","italic":false,"color":"white"}]']}} 1
item replace entity @s enderchest.11 with magma_block{scgui:1, scgui.action:11} 1
