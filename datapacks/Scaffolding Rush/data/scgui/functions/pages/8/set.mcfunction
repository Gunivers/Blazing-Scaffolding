...
item replace entity @s enderchest.11 with green_terracotta{scgui:1, scgui.action:11, display:{Name:'[{"text":"1s","italic":false,"color":"gold"}]',Lore:['[{"text":"1 seconde entre chaque montée","italic":false}]']}} 1
item replace entity @s enderchest.12 with lime_terracotta{scgui:1, scgui.action:12, display:{Name:'[{"text":"3s","italic":false,"color":"gold"}]',Lore:['[{"text":"3 secondes entre chaque montée","italic":false}]']}} 3
item replace entity @s enderchest.13 with yellow_terracotta{scgui:1, scgui.action:13, display:{Name:'[{"text":"5s","italic":false,"color":"gold"}]',Lore:['[{"text":"5 secondes entre chaque montée","italic":false}]']}} 5
item replace entity @s enderchest.14 with orange_terracotta{scgui:1, scgui.action:14, display:{Name:'[{"text":"7s","italic":false,"color":"gold"}]',Lore:['[{"text":"7 secondes entre chaque montée","italic":false}]']}} 7
