...
execute if score UseGravel options matches 1 run item modify entity @s enderchest.14 scgui:activate
execute unless score UseGravel options matches 1 run item modify entity @s enderchest.14 scgui:desactivate
