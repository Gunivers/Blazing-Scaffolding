...
item replace entity @s enderchest.15 with red_terracotta{scgui:1, scgui.action:15, display:{Name:'[{"text":"30s","italic":false,"color":"gold"}]',Lore:['[{"text":"30 secondes pour récupérer le villageois","italic":false}]']}} 30
