...
execute if score #admin.exist options matches 1 as @a[tag=!admin,scores={scgui.change=1}] run scoreboard players set @s scgui.page -1
execute unless score #admin.exist options matches 1 as @a[scores={scgui.page=-1}] run function scgui:pages/goto_menu

execute as @a unless score @s scgui.page matches -100..100 run function scgui:pages/goto_menu

execute as @a[scores={scgui.page=1..,scgui.change=1}] run scoreboard players operation @s scgui.XFreeze = @s pos.x
execute as @a[scores={scgui.page=1..,scgui.change=1}] run scoreboard players operation @s scgui.ZFreeze = @s pos.z

execute as @a[scores={scgui.page=1..}] unless score @s scgui.XFreeze = @s pos.x run function scgui:pages/goto_menu
execute as @a[scores={scgui.page=1..}] unless score @s scgui.ZFreeze = @s pos.z run function scgui:pages/goto_menu
