...
execute unless score Admin options matches 1 as @a[scores={scgui.page=-1}] run scoreboard players set @s scgui.change 1 
execute unless score Admin options matches 1 as @a[scores={scgui.page=-1,scgui.change=1}] run function scgui:pages/blank
execute unless score Admin options matches 1 as @a[scores={scgui.page=-1,scgui.change=1}] run scoreboard players set @s scgui.page 0
