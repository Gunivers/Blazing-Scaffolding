...
# tellraw @s[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"The preset ","color":"gray"},{"text":"Get Those F Flags","color":"light_purple"},{"text":" has been chosen","color":"gray"}]
# tellraw @s[scores={language=1}] ["",{"text":"[SR] ","color":"gold"},{"text":"Le préréglage ","color":"gray"},{"text":"Get Those F Flags","color":"light_purple"},{"text":" a été choisi","color":"gray"}]
