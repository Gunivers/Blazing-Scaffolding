...
# tellraw @a[scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The preset ","color":"gray"},{"text":"Bridge Chaos","color":"green"},{"text":" has been chosen","color":"gray"}]
# tellraw @a[scores={option_language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le préréglage ","color":"gray"},{"text":"Bridge Chaos","color":"green"},{"text":" a été choisi","color":"gray"}]
