...
# tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The preset ","color":"gray"},{"text":"Bridge Chaos","color":"green"},{"text":" has been chosen","color":"gray"}]
# tellraw @a[scores={option.language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le préréglage ","color":"gray"},{"text":"Bridge Chaos","color":"green"},{"text":" a été choisi","color":"gray"}]

scoreboard players set Preset options 6

# Map
scoreboard players set #lava.period.second options 0
