...
execute if score flag_hunt options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"The flag hunt has been ","color":"gray"},{"text":"deactivated","color":"red"}]
...
execute unless score flag_hunt options matches 0 run scoreboard objectives setdisplay sidebar
