...
execute if score TeamNumber options matches 2.. if score @s opt_team_number matches 2..4 run tellraw @s[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The number of teams has been set to ","color":"gray"},{"score":{"name":"TeamNumber","objective":"options"},"color":"gold"}]
execute if score TeamNumber options matches 2.. if score @s opt_team_number matches 2..4 run tellraw @s[scores={option.language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le nombre d'équipe a été mis sur ","color":"gray"},{"score":{"name":"TeamNumber","objective":"options"},"color":"gold"}]
