...
execute if score """+fake_player_name+""" options matches 0 run tellraw @s[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The """+option_name+""" option has been ","color":"gray"},{"text":"deactivated","color":"red"}]
execute unless score """+fake_player_name+""" options matches 0 run tellraw @s[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The """+option_name+""" option has been ","color":"gray"},{"text":"activated","color":"green"}]

execute if score """+fake_player_name+""" options matches 0 run tellraw @s[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"L'option """+option_name+""" a été ","color":"gray"},{"text":"désactivée","color":"red"}]
execute unless score """+fake_player_name+""" options matches 0 run tellraw @s[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"L'option """+option_name+""" a été ","color":"gray"},{"text":"activée","color":"green"}]
