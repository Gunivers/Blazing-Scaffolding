...
execute if score Volcano options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The volcanoes has been ","color":"gray"},{"text":"deactivated","color":"red"}]
execute unless score Volcano options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The volcanoes has been ","color":"gray"},{"text":"activated","color":"green"}]
