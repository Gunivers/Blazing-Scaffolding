...
execute if score InstantPillar options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"Les pilliers instantés ont été ","color":"gray"},{"text":"désactivés","color":"red"}]
execute unless score InstantPillar options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"Les pilliers instantés ont été ","color":"gray"},{"text":"activés","color":"green"}]
