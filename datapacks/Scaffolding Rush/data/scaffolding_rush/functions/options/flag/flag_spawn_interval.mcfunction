...
scoreboard players operation #flag.take_over.spawn_interval options = @s option.flag_spawn_interval
...
scoreboard players set @s option.flag_spawn_interval 0
scoreboard players enable @s option.flag_spawn_interval
