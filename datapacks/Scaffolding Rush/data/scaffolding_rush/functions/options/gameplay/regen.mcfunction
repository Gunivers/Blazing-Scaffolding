...
execute if score Regen options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"Regeneration has been ","color":"gray"},{"text":"deactivated","color":"red"}]
execute unless score Regen options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"Regeneration has been ","color":"gray"},{"text":"activated","color":"green"}]
