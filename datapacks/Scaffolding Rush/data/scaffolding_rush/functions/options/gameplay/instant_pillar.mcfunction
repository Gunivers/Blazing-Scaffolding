...
execute if score InstantPillar options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"The instant pillar has been ","color":"gray"},{"text":"deactivated","color":"red"}]
