...
with open("__main__.mcfunction", "a", encoding='utf-8') as f:
    f.write("execute as @a[tag=game_options_enabled] store result score @s usedTrigger run scoreboard players enable @s option_"+option_name+"\n")
...
execute if score @s option_"""+option_name+""" matches """+min_val+""".."""+max_val+""" run scoreboard players operation """+fake_player_name+""" options = @s option_"""+option_name+"""

tellraw @a[scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The """+option_name+""" option has been set to ","color":"gray"},{"score":{"name":\""""+fake_player_name+"""","objective":"options"},"color":"gold"},{"text":"","color":"gold"}]



tellraw @a[scores={option_language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"L'option """+option_name+""" a été mise à ","color":"gray"},{"score":{"name":\""""+fake_player_name+"""","objective":"options"},"color":"gold"},{"text":"","color":"gold"}]
