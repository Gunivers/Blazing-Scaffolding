...
execute as @a run tellraw @s[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The """+option_name+""" option has been set to ","color":"gray"},{"score":{"name":\""""+fake_player_name+"""","objective":"options"},"color":"gold"},{"text":"","color":"gold"}]



execute as @a run tellraw @s[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"L'option """+option_name+""" a été mise à ","color":"gray"},{"score":{"name":\""""+fake_player_name+"""","objective":"options"},"color":"gold"},{"text":"","color":"gold"}]
