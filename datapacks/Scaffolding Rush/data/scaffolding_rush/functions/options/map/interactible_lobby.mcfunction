...
execute if score InteractibleLobby options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Interactible lobby has been ","color":"gray"},{"text":"deactivated","color":"red"}]
...
execute unless score InteractibleLobby options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Interactible lobby has been ","color":"gray"},{"text":"activated","color":"green"}]
...
execute if score InteractibleLobby options matches 0 run tellraw @a[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le lobby intéractif a été ","color":"gray"},{"text":"désactivé","color":"red"}]
...
execute unless score InteractibleLobby options matches 0 run tellraw @a[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le lobby intéractif a été ","color":"gray"},{"text":"activé","color":"green"}]
