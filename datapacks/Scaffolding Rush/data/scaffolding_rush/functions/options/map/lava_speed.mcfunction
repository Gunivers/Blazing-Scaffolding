...
execute if score @s opt_lava_speed matches 0.. run scoreboard players operation #lava.period.second options = @s opt_lava_speed
execute if score @s opt_lava_speed matches ..-1 run scoreboard players operation #lava.period.second options = 0 const
