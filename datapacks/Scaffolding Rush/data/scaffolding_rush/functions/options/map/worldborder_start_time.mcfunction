...
scoreboard players operation #worldborder.start_time.second options = @s option.worldborder_start_time
execute if score @s option.worldborder_start_time matches ..-1 run scoreboard players operation #worldborder.start_time.second options = 0 const
...
scoreboard players set @s option.worldborder_start_time 0
