...
execute if score WorldborderShrink options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The worldborder_shrink option has been ","color":"gray"},{"text":"deactivated","color":"red"}]
execute unless score WorldborderShrink options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The worldborder_shrink option has been ","color":"gray"},{"text":"activated","color":"green"}]
