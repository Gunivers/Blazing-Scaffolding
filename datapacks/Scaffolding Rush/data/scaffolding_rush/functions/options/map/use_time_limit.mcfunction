...
execute if score UseTimeLimit options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The use_time_limit option has been ","color":"gray"},{"text":"deactivated","color":"red"}]
execute unless score UseTimeLimit options matches 0 run tellraw @a[scores={option.language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The use_time_limit option has been ","color":"gray"},{"text":"activated","color":"green"}]
