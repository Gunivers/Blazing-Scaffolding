...
execute if score FallDamage options matches 0 run tellraw @a[scores={language=0}] ["",{"text":"[SR] ","color":"gold"},{"text":"The Fall Damage has been ","color":"gray"},{"text":"deactivated","color":"red"}]
