...
# execute if score #admin.exist options matches 1 run tellraw @a[scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The option book is ","color":"gray"},{"text":"closed","color":"red"}]
# execute if score #admin.exist options matches 0 run tellraw @a[scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"The option book is ","color":"gray"},{"text":"open","color":"green"}]
execute if score #admin.exist options matches 1.. run tellraw @a[scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"selector":"@a[scores={option_admin=1}]","color":"gold"},{"text":" is now the administrator","color":"gray"}]

# execute if score #admin.exist options matches 1 run tellraw @a[scores={option_language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le livre d'option est ","color":"gray"},{"text":"fermé","color":"red"}]
# execute if score #admin.exist options matches 0 run tellraw @a[scores={option_language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Le livre d'option est ","color":"gray"},{"text":"ouvert","color":"green"}]
execute if score #admin.exist options matches 1.. run tellraw @a[scores={option_language=1}] ["",{"text":"[BS] ","color":"gold"},{"selector":"@a[scores={option_admin=1}]","color":"gold"},{"text":" est maintenant l'administrateur de partie","color":"gray"}]
...
execute if score #lobby.active data matches 1 run scoreboard players enable @a option_language
