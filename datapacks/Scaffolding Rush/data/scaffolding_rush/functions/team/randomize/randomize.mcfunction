...
tellraw @a[team=blue,scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Teams randomized! Your new team mates are: ","color":"gray"},{"selector":"@a[team=blue]","color":"blue"}]
...
tellraw @a[team=red,scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Teams randomized! Your new team mates are: ","color":"gray"},{"selector":"@a[team=red]","color":"red"}]
...
tellraw @a[team=green,scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Teams randomized! Your new team mates are: ","color":"gray"},{"selector":"@a[team=green]","color":"green"}]
...
tellraw @a[team=yellow,scores={option_language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Teams randomized! Your new team mates are: ","color":"gray"},{"selector":"@a[team=yellow]","color":"yellow"}]
