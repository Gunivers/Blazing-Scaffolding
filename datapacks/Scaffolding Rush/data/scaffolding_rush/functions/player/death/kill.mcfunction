...
execute if entity @s[team=red] if entity @e[type=villager,tag=respawn_villager,tag=red_villager] run tag @s add Respawning
execute if entity @s[team=blue] if entity @e[type=villager,tag=respawn_villager,tag=blue_villager] run tag @s add Respawning
execute if entity @s[team=yellow] if entity @e[type=villager,tag=respawn_villager,tag=yellow_villager] run tag @s add Respawning
execute if entity @s[team=green] if entity @e[type=villager,tag=respawn_villager,tag=green_villager] run tag @s add Respawning
