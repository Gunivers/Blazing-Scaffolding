...
tellraw @s[scores={option_language=0}] ["",{"text":"[BS]","color":"gold"},{"text":" A game is already running. You can join a game after they finish it!\n\n ","color":"gray"}]
tellraw @s[scores={option_language=1}] ["",{"text":"[BS]","color":"gold"},{"text":" Une partie est déjà en cours. Vous pourrez rejoindre après la fin de partie !\n\n ","color":"gray"}]
