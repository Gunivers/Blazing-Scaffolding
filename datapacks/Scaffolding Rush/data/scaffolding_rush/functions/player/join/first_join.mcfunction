scoreboard players set @s option.language 0
...
tellraw @s [ \
    ...
    {"text":"[English]","color":"green","clickEvent":{"action":"run_command","value":"/trigger option.language set 1"}}, \
    {"text":" ","color":"green"},{"text":"[Français]","color":"green","clickEvent":{"action":"run_command","value":"/trigger option.language set 2"}}, \
    {"text":"\n "} \
]
