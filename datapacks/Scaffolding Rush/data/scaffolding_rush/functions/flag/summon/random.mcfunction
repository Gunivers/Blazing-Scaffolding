...
execute if score alea global matches 0..69 run function scaffolding_rush:flag/summon/1
execute if score alea global matches 70..94 run function scaffolding_rush:flag/summon/2
execute if score alea global matches 95..100 run function scaffolding_rush:flag/summon/5
