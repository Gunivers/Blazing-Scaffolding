...
tag @e[type=armor_stand,tag=selected,tag=Flag,limit=1] add flagOne
execute as @e[type=armor_stand,tag=selected,tag=Flag,limit=1] run function scaffolding_rush:flag/banner/head/1
