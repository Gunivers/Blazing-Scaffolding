...
execute unless score LavaLevel global matches ..2 as @e[type=marker,name="ScR_LavaLevel",limit=1] at @s run fill ~-8 ~-2 ~-8 ~8 ~-2 ~8 minecraft:magma_block replace #scaffolding_rush:lava_replace
