...
#depositing flag
execute unless score FlagTakeOver options matches 0 as @a[tag=flag_carry,team=blue] at @s if entity @e[type=villager,distance=..1, team=blue] run function scaffolding_rush:flag/claim/team/blue
execute unless score FlagTakeOver options matches 0 as @a[tag=flag_carry,team=red] at @s if entity @e[type=villager,distance=..1,team=red] run function scaffolding_rush:flag/claim/team/red
execute unless score FlagTakeOver options matches 0 as @a[tag=flag_carry,team=green] at @s if entity @e[type=villager,distance=..1,team=green] run function scaffolding_rush:flag/claim/team/green
execute unless score FlagTakeOver options matches 0 as @a[tag=flag_carry,team=yellow] at @s if entity @e[type=villager,distance=..1,team=yellow] run function scaffolding_rush:flag/claim/team/yellow
