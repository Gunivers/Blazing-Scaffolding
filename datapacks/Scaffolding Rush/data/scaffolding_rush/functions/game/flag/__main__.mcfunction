...
execute as @a[tag=flag_carry,team=red] at @s if entity @e[type=villager,tag=game_villager,distance=..1,team=red] run function scaffolding_rush:game/flag/claim/team/red
execute as @a[tag=flag_carry,team=green] at @s if entity @e[type=villager,tag=game_villager,distance=..1,team=green] run function scaffolding_rush:game/flag/claim/team/green
execute as @a[tag=flag_carry,team=yellow] at @s if entity @e[type=villager,tag=game_villager,distance=..1,team=yellow] run function scaffolding_rush:game/flag/claim/team/yellow
