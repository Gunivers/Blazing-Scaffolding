...
execute if entity @s[team=blue] at @s run playsound block.note_block.bell ambient @a[team=blue] ~ ~ ~ 1000 1.53 1
execute if entity @s[team=green] at @s run playsound block.note_block.bell ambient @a[team=green] ~ ~ ~ 1000 1.53 1
execute if entity @s[team=red] at @s run playsound block.note_block.bell ambient @s[team=red] ~ ~ ~ 1000 1.53 1
execute if entity @s[team=yellow] at @s run playsound block.note_block.bell ambient @s[team=yellow] ~ ~ ~ 1000 1.53 1
