...
execute if entity @s[team=red] run tellraw @a ["",{"text":"[","color":"red"},{"selector":"@s","color":"red"},{"text":"]","color":"red"},{"text":" +5 points","color":"gray"}]
execute if entity @s[team=yellow] run tellraw @a ["",{"text":"[","color":"yellow"},{"selector":"@s","color":"yellow"},{"text":"]","color":"yellow"},{"text":" +5 points","color":"gray"}]
