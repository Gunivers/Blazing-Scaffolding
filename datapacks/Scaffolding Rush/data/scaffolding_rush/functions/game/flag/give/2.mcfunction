...
title @s title {"text":""}
execute if score @s option_language matches 0 run title @s subtitle {"text":"Bring it back to your villager!","color":"yellow"}
execute if score @s option_language matches 1 run title @s subtitle {"text":"Raporte le à ton villageois !","color":"yellow"}