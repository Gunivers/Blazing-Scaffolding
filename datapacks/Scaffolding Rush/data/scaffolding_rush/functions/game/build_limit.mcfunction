...
scoreboard players operation @e[type=marker,name="ScR_BuildLimit"] pos.y = LavaLevel data
scoreboard players operation @e[type=marker,name="ScR_BuildLimit"] pos.y += BuildHeight options
execute as @e[type=marker,name="ScR_BuildLimit"] store result entity @s Pos[1] double 1 run scoreboard players get @s pos.y
