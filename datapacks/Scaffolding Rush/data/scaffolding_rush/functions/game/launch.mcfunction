...
execute if score RemainingTeam global matches ..1 run tellraw @a[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Not enough teams","color":"red"}]
...
execute if score RemainingTeam global matches ..1 run tellraw @a[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Pas assez de team !","color":"red"}]
execute if score ClearGame global matches 1 run tellraw @a[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Please wait, a clear of the map is in progress","color":"red"}]
