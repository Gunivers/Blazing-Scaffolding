...
execute if score RemainingTeam global matches 2.. if score ClearGame global matches 0 unless score DevelopementMode global matches 1 run function scaffolding_rush:game/countdown
