...
execute as @a[gamemode=spectator,team=blue] if entity @a[scores={bluePlaced=1..}] if entity @e[type=villager,tag=blue_villager,limit=1] run function scaffolding_rush:game/villager/player_respawn/blue
execute as @a[gamemode=spectator,team=green] if entity @a[scores={greenPlaced=1..}] if entity @e[type=villager,tag=green_villager,limit=1] run function scaffolding_rush:game/villager/player_respawn/green
execute as @a[gamemode=spectator,team=red] if entity @a[scores={redPlaced=1..}] if entity @e[type=villager,tag=red_villager,limit=1] run function scaffolding_rush:game/villager/player_respawn/red
execute as @a[gamemode=spectator,team=yellow] if entity @a[scores={yellowPlaced=1..}] if entity @e[type=villager,tag=yellow_villager,limit=1] run function scaffolding_rush:game/villager/player_respawn/yellow
