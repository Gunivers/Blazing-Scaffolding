...
execute as @e[type=villager,tag=game.villager] at @s store result score @s pos.x run data get entity @s Pos[0]
execute as @e[type=villager,tag=game.villager] at @s store result score @s pos.y run data get entity @s Pos[1]
execute as @e[type=villager,tag=game.villager] at @s store result score @s pos.z run data get entity @s Pos[2]
...
team join blue @e[type=villager,tag=new_villager,tag=blue_villager,tag=game.villager]
team join green @e[type=villager,tag=new_villager,tag=green_villager,tag=game.villager]
team join red @e[type=villager,tag=new_villager,tag=red_villager,tag=game.villager]
team join yellow @e[type=villager,tag=new_villager,tag=yellow_villager,tag=game.villager]
tag @e[type=villager,tag=new_villager,tag=game.villager] remove new_villager
...
execute as @e[type=villager,tag=game.villager] run function scaffolding_rush:game/villager/warn/test
...
execute if score Movable#villager.enabled options matches 1 unless entity @e[type=minecraft:villager,tag=game.villager,nbt={ActiveEffects:[{Id:25}]}] as @a[gamemode=!spectator,tag=!Respawning,tag=!facing_villager] run function scaffolding_rush:game/villager/warn/msg_actionbar
execute if score Movable#villager.enabled options matches 1 unless entity @e[type=minecraft:villager,tag=game.villager,nbt={ActiveEffects:[{Id:25}]}] as @a[gamemode=!spectator,tag=!Respawning] run function scaffolding_rush:game/villager/warn/msg_title

function scaffolding_rush:game/villager/health_bar

execute as @e[type=minecraft:villager,tag=game.villager] at @s if entity @a[distance=..0.5] run effect give @s minecraft:invisibility 1 1 true

execute as @e[type=minecraft:villager,tag=game.villager] at @s unless block ~ ~ ~ #scaffolding_rush:air unless block ~ ~ ~ #scaffolding_rush:scaffolding run tp @s ~ ~0.1 ~


# Protect vilalger against arrows
execute as @e[type=minecraft:villager,tag=game.villager] at @s positioned ~ ~1 ~ run function scaffolding_rush:game/villager/arrow_shield
