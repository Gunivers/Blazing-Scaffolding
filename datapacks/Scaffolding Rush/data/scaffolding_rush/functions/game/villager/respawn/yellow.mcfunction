...
execute if score VillagerForgiveness options matches 1 as @a[team=yellow,gamemode=!spectator] run function scaffolding_rush:game/villager/respawn/egg_counter/give
execute if score VillagerForgiveness options matches 1 run schedule function scaffolding_rush:game/villager/respawn/egg_counter/yellow 1s
