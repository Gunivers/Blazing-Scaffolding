...
execute as @e[type=villager,tag=yellow_villager] run function utils:clean_kill

execute as @s[nbt=!{SelectedItem: {}}] run loot replace entity @s weapon.mainhand loot scaffolding_rush:egg
execute as @s[nbt=!{Inventory: [{id: "minecraft:blaze_spawn_egg"}]}] run loot give @s loot scaffolding_rush:egg
