#trigger respawn
execute if score Villager options matches 1 if entity @a[team=blue,gamemode=!spectator] unless entity @e[type=villager,tag=game_villager,tag=blue_villager,limit=1] unless entity @a[tag=has_egg,team=blue] run function scaffolding_rush:villager/respawn/test/blue
execute if score Villager options matches 1 if entity @a[team=green,gamemode=!spectator] unless entity @e[type=villager,tag=game_villager,tag=green_villager,limit=1] unless entity @a[tag=has_egg,team=green] run function scaffolding_rush:villager/respawn/test/green
execute if score Villager options matches 1 if entity @a[team=red,gamemode=!spectator] unless entity @e[type=villager,tag=game_villager,tag=red_villager,limit=1] unless entity @a[tag=has_egg,team=red] run function scaffolding_rush:villager/respawn/test/red
execute if score Villager options matches 1 if entity @a[team=yellow,gamemode=!spectator] unless entity @e[type=villager,tag=game_villager,tag=yellow_villager,limit=1] unless entity @a[tag=has_egg,team=yellow] run function scaffolding_rush:villager/respawn/test/yellow
