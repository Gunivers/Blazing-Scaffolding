...
execute if entity @e[type=villager,tag=respawn_villager,limit=1,sort=nearest,tag=red_villager] run summon marker ~ ~ ~ {Tags:["VillagerArrowShield","Red"]}
execute if entity @e[type=villager,tag=respawn_villager,limit=1,sort=nearest,tag=blue_villager] run summon marker ~ ~ ~ {Tags:["VillagerArrowShield","Blue"]}
execute if entity @e[type=villager,tag=respawn_villager,limit=1,sort=nearest,tag=green_villager] run summon marker ~ ~ ~ {Tags:["VillagerArrowShield","Green"]}
execute if entity @e[type=villager,tag=respawn_villager,limit=1,sort=nearest,tag=yellow_villager] run summon marker ~ ~ ~ {Tags:["VillagerArrowShield","Yellow"]}
