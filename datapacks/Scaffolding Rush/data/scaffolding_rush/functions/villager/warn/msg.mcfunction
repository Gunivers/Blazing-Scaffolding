...
execute if entity @e[type=villager,tag=red_villager] run title @a[scores={language=0},team=red] actionbar ["",{"text":"Your Villager is "},{"score":{"name":"@e[type=villager,tag=red_villager,limit=1]","objective":"YEntity"}},{"text":" blocks above lava"}]
execute if entity @e[type=villager,tag=yellow_villager] run title @a[scores={language=0},team=yellow] actionbar ["",{"text":"Your Villager is "},{"score":{"name":"@e[type=villager,tag=yellow_villager,limit=1]","objective":"YEntity"}},{"text":" blocks above lava"}]
...
execute if entity @e[type=villager,tag=red_villager] run title @a[scores={language=1},team=red] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,tag=red_villager,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
execute if entity @e[type=villager,tag=yellow_villager] run title @a[scores={language=1},team=yellow] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,tag=yellow_villager,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
