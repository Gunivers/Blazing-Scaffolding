#trigger respawn
execute if score NoVillager options matches 0 if entity @a[team=blue,gamemode=!spectator] unless entity @e[type=villager,team=blue,limit=1] unless entity @a[tag=has_egg,team=blue] run function scaffolding_rush:villager/respawn/test/blue
execute if score NoVillager options matches 0 if entity @a[team=green,gamemode=!spectator] unless entity @e[type=villager,team=green,limit=1] unless entity @a[tag=has_egg,team=green] run function scaffolding_rush:villager/respawn/test/green
execute if score NoVillager options matches 0 if entity @a[team=red,gamemode=!spectator] unless entity @e[type=villager,team=red,limit=1] unless entity @a[tag=has_egg,team=red] run function scaffolding_rush:villager/respawn/test/red
execute if score NoVillager options matches 0 if entity @a[team=yellow,gamemode=!spectator] unless entity @e[type=villager,team=yellow,limit=1] unless entity @a[tag=has_egg,team=yellow] run function scaffolding_rush:villager/respawn/test/yellow
