...
execute as @e[type=villager,tag=respawn_villager] if score @s pos.x > WBbyTwo data run kill @s
execute as @e[type=villager,tag=respawn_villager] if score @s pos.x < -WBbyTwo data run kill @s
execute as @e[type=villager,tag=respawn_villager] if score @s pos.z > WBbyTwo data run kill @s
execute as @e[type=villager,tag=respawn_villager] if score @s pos.z < -WBbyTwo data run kill @s
