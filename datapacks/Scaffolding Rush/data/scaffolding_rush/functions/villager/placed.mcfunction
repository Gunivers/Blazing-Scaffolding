...
#Recup delay
tellraw @s[scores={language=0}] ["",{"text":"[BS] ","color":"gold"},{"text":"Villager placed. You can't move it during the next ","color":"gray"},{"text":"5","color":"gold"},{"text":" seconds","color":"gray"}]
tellraw @s[scores={language=1}] ["",{"text":"[BS] ","color":"gold"},{"text":"Villager placé. Vous ne pouvez plus le bouger durant les ","color":"gray"},{"text":"5","color":"gold"},{"text":" prochaines secondes","color":"gray"}]
