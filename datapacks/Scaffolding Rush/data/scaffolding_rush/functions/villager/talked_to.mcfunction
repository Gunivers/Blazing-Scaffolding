...
execute if score GameRunning global matches 1 unless score MovableVillager options matches 0 if entity @s[tag=!VillagerRecup,tag=!Respawning] as @s run function scaffolding_rush:villager/egg/give/any
