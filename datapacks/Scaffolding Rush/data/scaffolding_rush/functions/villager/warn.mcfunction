...
execute if entity @e[type=villager,tag=blue_villager] run title @a[scores={language=0},team=blue] actionbar ["",{"text":"Your Villager is "},{"score":{"name":"@e[type=villager,team=blue,limit=1]","objective":"YEntity"}},{"text":" blocks above lava"}]
...
execute if entity @e[type=villager,tag=green_villager] run title @a[scores={language=0},team=green] actionbar ["",{"text":"Your Villager is "},{"score":{"name":"@e[type=villager,team=green,limit=1]","objective":"YEntity"}},{"text":" blocks above lava"}]

execute if entity @e[type=villager,tag=blue_villager] run title @a[scores={language=1},team=blue] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,team=blue,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
