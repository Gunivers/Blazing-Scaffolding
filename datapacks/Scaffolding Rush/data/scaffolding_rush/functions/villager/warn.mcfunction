...
execute if entity @e[type=villager,team=blue] run title @a[scores={language=0},team=blue] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,team=blue,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
execute if entity @e[type=villager,team=red] run title @a[scores={language=0},team=red] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,team=red,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
execute if entity @e[type=villager,team=yellow] run title @a[scores={language=0},team=yellow] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,team=yellow,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
execute if entity @e[type=villager,team=green] run title @a[scores={language=0},team=green] actionbar ["",{"text":"Votre Villageois est "},{"score":{"name":"@e[type=villager,team=green,limit=1]","objective":"YEntity"}},{"text":" bloc·s au dessus de la lave"}]
