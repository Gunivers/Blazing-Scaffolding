...
execute as @e[type=marker,name="ScR_LavaLevel",limit=1] at @s run teleport @s ~ ~-2 ~
...
execute as @e[type=marker,name="ScR_LavaLevel",limit=1] if score @s YEntity matches ..2 at @s run function scaffolding_rush:clear/finish
