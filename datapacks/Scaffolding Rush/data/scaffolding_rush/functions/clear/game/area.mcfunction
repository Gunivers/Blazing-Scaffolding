...
execute at @e[type=marker,name="ScR_ClearGame",limit=1] run fill ~-90 ~ ~-90 ~90 ~ ~90 air replace #scaffolding_rush:clear_game
execute at @e[type=marker,name="ScR_ClearGame",limit=1] run fill ~-90 ~-1 ~-90 ~90 ~-1 ~90 air replace #scaffolding_rush:clear_game
...
execute unless score @e[type=marker,name="ScR_ClearGame",limit=1] YEntity matches ..2 run schedule function scaffolding_rush:clear/game/area 1t
execute as @e[type=marker,name="ScR_ClearGame",limit=1] if score @s YEntity matches ..2 at @s run function scaffolding_rush:clear/game/finish
