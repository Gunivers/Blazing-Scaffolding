...
#execute as @a[tag=has_egg,scores={villagerPlaced=0}] unless data entity @s Inventory[{id:"minecraft:villager_spawn_egg"}] run function scaffolding_rush:villager/give/any
