...
execute if score RandomTeam options matches 1 run function scaffolding_rush:scaffolding_rush/team/join/random

function scaffolding_rush:scaffolding_rush/broadcast/10s

schedule function scaffolding_rush:scaffolding_rush/clear/launch 2s
...
schedule function scaffolding_rush:scaffolding_rush/team/create_base/create 4s

schedule function scaffolding_rush:scaffolding_rush/broadcast/5s 5s
schedule function scaffolding_rush:scaffolding_rush/broadcast/4s 6s
schedule function scaffolding_rush:scaffolding_rush/broadcast/3s 7s
schedule function scaffolding_rush:scaffolding_rush/broadcast/2s 8s
schedule function scaffolding_rush:scaffolding_rush/broadcast/1s 9s
schedule function scaffolding_rush:scaffolding_rush/game/start 10s

#disable trigers
function scaffolding_rush:scaffolding_rush/options/disable_all
