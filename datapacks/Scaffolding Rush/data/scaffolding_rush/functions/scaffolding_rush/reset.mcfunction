...
function scaffolding_rush:scaffolding_rush/clear/launch
execute as @e[type=villager] run function scaffolding_rush:scaffolding_rush/clean_kill

schedule clear scaffolding_rush:scaffolding_rush/clear/launch
schedule clear scaffolding_rush:scaffolding_rush/team/create_base/create
schedule clear scaffolding_rush:scaffolding_rush/broadcast/5s
schedule clear scaffolding_rush:scaffolding_rush/broadcast/4s
schedule clear scaffolding_rush:scaffolding_rush/broadcast/3s
schedule clear scaffolding_rush:scaffolding_rush/broadcast/2s
schedule clear scaffolding_rush:scaffolding_rush/broadcast/1s
schedule clear scaffolding_rush:scaffolding_rush/game/start
schedule clear scaffolding_rush:scaffolding_rush/lava/sound
...
function scaffolding_rush:scaffolding_rush/options/activate_all

function scaffolding_rush:scaffolding_rush/options/labels
...
function scaffolding_rush:scaffolding_rush/lobby/load
execute as @a run function scaffolding_rush:scaffolding_rush/lobby/give_items
