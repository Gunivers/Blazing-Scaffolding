...
function scaffolding_rush:scaffolding_rush/options/any

execute if entity @a[scores={StartGame=1..}] run function scaffolding_rush:scaffolding_rush/game/countdown
execute if entity @a[scores={Reset=1..}] run function scaffolding_rush:scaffolding_rush/reset


#Lobby main
execute if score GameLobby global matches 1 run function scaffolding_rush:scaffolding_rush/lobby/main

execute as @a unless score @s gameId = GameId global as @s run function scaffolding_rush:scaffolding_rush/join/main

#villager placed
execute as @a[scores={bluePlaced=1..}] run function scaffolding_rush:scaffolding_rush/villager/placed
execute as @a[scores={greenPlaced=1..}] run function scaffolding_rush:scaffolding_rush/villager/placed
execute as @a[scores={redPlaced=1..}] run function scaffolding_rush:scaffolding_rush/villager/placed
execute as @a[scores={yellowPlaced=1..}] run function scaffolding_rush:scaffolding_rush/villager/placed

#==Gameplay==
#game logic
execute if score GameRunning global matches 1 run function scaffolding_rush:scaffolding_rush/game/main
...
execute if score InstantPillar options matches 1 as @e[type=area_effect_cloud ,name="ScR_Pillar"] at @s run function scaffolding_rush:scaffolding_rush/pillar/start

#items
execute as @e[type=item,tag=!processed] run function scaffolding_rush:scaffolding_rush/item/catch_drop

#snowball
execute as @e[type=snowball,tag=!t] at @s run function scaffolding_rush:scaffolding_rush/item/snowball
...
execute as @e[type=villager,nbt=!{Age:0}] run function scaffolding_rush:scaffolding_rush/clean_kill
