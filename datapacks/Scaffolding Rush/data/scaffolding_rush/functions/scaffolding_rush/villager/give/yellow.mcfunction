...
execute as @e[type=villager,team=yellow] run function scaffolding_rush:scaffolding_rush/clean_kill
...
advancement revoke @a only scaffolding_rush:scaffolding_rush/grab_villager/yellow
