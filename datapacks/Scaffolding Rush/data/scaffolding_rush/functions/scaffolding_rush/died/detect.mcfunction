...
execute if entity @s[type=minecraft:villager] run function scaffolding_rush:scaffolding_rush/clean_kill
...
execute as @s[gamemode=!spectator] run schedule function scaffolding_rush:scaffolding_rush/died/loop_tp 1t

#Recup delay
tag @s[gamemode=!spectator,tag=!has_egg] add VillagerRecup
schedule function scaffolding_rush:scaffolding_rush/villager/give/recup_delay 15t
