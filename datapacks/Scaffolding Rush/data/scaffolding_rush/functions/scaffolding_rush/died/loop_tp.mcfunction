...
execute as @a[scores={killed=1..},tag=Respawning] run schedule function scaffolding_rush:scaffolding_rush/died/loop_tp 1t
execute as @a[scores={killed=0},tag=Respawning] run function scaffolding_rush:scaffolding_rush/died/loop_end
