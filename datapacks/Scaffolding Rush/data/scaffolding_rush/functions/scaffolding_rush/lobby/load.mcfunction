...
setblock 0 2 0 minecraft:structure_block[mode=load]{mode:"LOAD",posX:-20,posY:0,posZ:-14,name:"scaffolding_rush:scaffolding_rush/lobby"}
setblock 0 3 0 minecraft:redstone_block

scoreboard players set GameLobby global 1

execute if score RandomTeam options matches 0 run function scaffolding_rush:scaffolding_rush/lobby/team
execute if score RandomTeam options matches 1 run function scaffolding_rush:scaffolding_rush/lobby/random
