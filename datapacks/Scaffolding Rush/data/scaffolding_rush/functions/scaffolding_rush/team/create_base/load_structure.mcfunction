setblock ~ 2 ~ minecraft:structure_block[mode=load]{mode:"LOAD",posX:-2,posY:0,posZ:-2,sizeX:5,sizeY:4,sizeZ:5,name:"scaffolding_rush:scaffolding_rush/base_team"}
