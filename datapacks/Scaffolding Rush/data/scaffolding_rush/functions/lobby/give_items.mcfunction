...
execute unless score InteractibleLobby options matches 0 if score UseSnowball options matches 1.. run give @s minecraft:snowball{HideFlags: 24, CanDestroy: ["minecraft:scaffolding", "#scaffolding_rush:lobby", "#scaffolding_rush:tower"]} 42
execute if score InteractibleLobby options matches 0 if score UseSnowball options matches 1.. run give @s minecraft:snowball{HideFlags: 24, CanDestroy: []} 42
