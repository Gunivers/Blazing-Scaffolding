...
execute unless score InteractibleLobby options matches 0 if score UseSand options matches 1.. run loot give @s loot scaffolding_rush:lobby_sand
execute if score InteractibleLobby options matches 0 if score UseSand options matches 1.. run loot give @s loot scaffolding_rush:lobby_sand_no_interactions
