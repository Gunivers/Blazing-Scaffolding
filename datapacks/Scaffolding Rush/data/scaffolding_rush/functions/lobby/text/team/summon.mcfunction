...
summon minecraft:text_display 6 25.2 6 {text: '', Tags: ["lobbyText", "teamNumberActionsLabel"], billboard: 'fixed', transformation: {translation: [0f, 0f, 0f], left_rotation: [0f, 0.907f, 0f, -0.421f], scale: [1f, 1f, 1f], right_rotation: [0f, 0f, 0f, 1f]}, background: 0, shadow: 1b, brightness: {block: 10, sky: 10}}
