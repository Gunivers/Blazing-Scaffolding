...
#execute if score RandomTeam options matches 0 run 
function scaffolding_rush:lobby/text/team/team_label
...
data merge entity @e[type=minecraft:text_display,tag=lobbyRandomLabel,limit=1] {text: '{"text":"randomize","color":"dark_purple","strikethrough":false}'}
