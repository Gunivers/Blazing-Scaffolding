...
data merge entity @e[type=minecraft:text_display,tag=presetLabel,limit=1] {text:'["",{"text":"a?! ","obfuscated":true,"color":"aqua"},{"text":"Chaos","color":"aqua"},{"text":" ?:§","obfuscated":true,"color":"aqua"}]'}
