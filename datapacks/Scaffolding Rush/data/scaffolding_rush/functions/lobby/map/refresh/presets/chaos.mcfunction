...
data merge entity @e[type=minecraft:text_display,tag=presetLabel,limit=1] {text:'["",{"text":"a?! ","obfuscated":true,"color":"aqua"},{"translate":"blazing_scaffolding.chaos","color":"aqua"},{"text":" ?:§","obfuscated":true,"color":"aqua"}]'}
