...
execute as @a[team=!red] if score @s playerID = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interactionID run function scaffolding_rush:team/join/red
