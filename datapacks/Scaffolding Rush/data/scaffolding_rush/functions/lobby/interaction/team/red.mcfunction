...
execute as @a[team=!red] if score @s uuid = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interaction.uuid at @s run function scaffolding_rush:team/join/red
