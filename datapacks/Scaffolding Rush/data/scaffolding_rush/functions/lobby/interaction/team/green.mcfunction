...
execute as @a[team=!green] if score @s playerID = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interactionID at @s run function scaffolding_rush:team/join/green
