...
execute as @a[team=!random] if score @s uuid = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interaction.uuid run function scaffolding_rush:team/join/random
