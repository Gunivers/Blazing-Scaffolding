...
execute if score Preset options matches 1 as @a if score @s playerID = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interactionID run scoreboard players operation @s opt_preset -= #1 const
