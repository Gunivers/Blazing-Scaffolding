...
execute if score Preset options matches 1 as @a if score @s UUID = @e[type=minecraft:interaction,tag=interactionSelect,limit=1] interaction.UUID run scoreboard players operation @s opt_preset -= 1 const
