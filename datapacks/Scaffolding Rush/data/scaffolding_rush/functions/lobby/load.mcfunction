...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=lobbyText,name="Options"] run summon area_effect_cloud 7 4.5 -2 {CustomName: '{"text":"Options","bold":true}', Tags: ["lobbyText"], CustomNameVisible: 1, Age: -2147483648, Duration: -1, WaitTime: -2147483648}
