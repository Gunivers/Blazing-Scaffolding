#check X
execute as @a[gamemode=!spectator] at @s if score @s XEntity > WBbyTwo global run tp @s 0 ~ ~
execute as @a[gamemode=!spectator] at @s if score @s XEntity < -WBbyTwo global run tp @s 0 ~ ~ 
...
#check Z
execute as @a[gamemode=!spectator] at @s if score @s ZEntity > WBbyTwo global run tp @s ~ ~ 0
execute as @a[gamemode=!spectator] at @s if score @s ZEntity < -WBbyTwo global run tp @s ~ ~ 0
