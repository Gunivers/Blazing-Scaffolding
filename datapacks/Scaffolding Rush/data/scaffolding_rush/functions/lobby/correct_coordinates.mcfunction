...
#suffocation
execute as @a[gamemode=!spectator] at @s if score GameRunning global matches 0 if block ~ ~ ~ #scaffolding_rush:lobby run function scaffolding_rush:lobby/suffocation