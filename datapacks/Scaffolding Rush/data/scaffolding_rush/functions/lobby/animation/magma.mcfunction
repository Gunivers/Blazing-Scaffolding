...
execute as @e[type=minecraft:block_display,tag=lobbyMagma] store result score @s XEntity run data get entity @s Pos[0]
execute as @e[type=minecraft:block_display,tag=lobbyMagma] at @s if score @s XEntity matches 9.. run kill @s
