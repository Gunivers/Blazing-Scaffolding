...
execute if score tick200 global matches 1 run schedule function scaffolding_rush:lobby/text/team/restore_villager_pos/green 65t
...
execute if score tick200 global matches 1 run schedule function scaffolding_rush:lobby/text/team/restore_villager_pos/yellow 70t
