...
#Bossbar
execute if score UseTimeLimit options matches 0 unless score LavaSpeed options matches 0 run bossbar set minecraft:filling_lava players @a
execute if score UseTimeLimit options matches 0 unless score LavaSpeed options matches 0 run bossbar set minecraft:filling_lava visible true
execute if score UseTimeLimit options matches 0 unless score LavaSpeed options matches 0 run execute store result bossbar filling_lava max run scoreboard players get LavaSpeedTics options
