...
execute as @s at @s store result score @s pos.z run data get entity @s Pos[2]
...
#second room
execute if score @s pos.x matches 16.. run function scaffolding_rush:tutorial/room/create_room2
#exit
