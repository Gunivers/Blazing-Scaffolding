...
summon minecraft:interaction 6 24.0 4 {width: 1b, height: 1.5f, Tags: ["lobbyTeam", "lobbyColorTeam", "lobbyInteraction", "teamBlue"]}
...
summon minecraft:interaction 4 24.0 6 {width: 1b, height: 1.5f, Tags: ["lobbyTeam", "lobbyColorTeam", "lobbyInteraction", "teamRed"]}
...
summon minecraft:interaction 8 24.0 -3 {width: 1b, height: 1.5f, Tags: ["lobbyTeam", "lobbyColorTeam", "lobbyInteraction", "teamSpectate"]}
