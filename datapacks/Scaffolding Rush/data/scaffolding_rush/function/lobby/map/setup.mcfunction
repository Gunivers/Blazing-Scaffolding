...
summon minecraft:text_display 7.9 25.1 -4.0 {text: '["",{"text":"Tutorial","color":"aqua"}]',transformation:[0f, 0f, -1f, 0f, 0f, 1f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 0f, 0f, 1f], Tags: ["lobbyText","LobbyTutoAccess"], billboard: 'fixed', background: 0, brightness: {block: 10, sky: 10}}
