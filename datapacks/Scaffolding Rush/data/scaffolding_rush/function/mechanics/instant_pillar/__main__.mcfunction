...
execute as @e[type=falling_block,nbt={BlockState: {Name: "minecraft:scaffolding"}}] positioned -1500 -64 500 unless entity @s[dx=1000,dy=512,dz=1000] at @s run summon minecraft:marker ~ ~ ~ {CustomName: '{"text":"ScR_Pillar"}'}
