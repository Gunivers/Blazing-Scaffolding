...
scoreboard players operation TimeLeftDisplayMinutes timer = #game.time.left timer
...
scoreboard players operation TimeLeftDisplaySeconds timer = #game.time.left timer
...
execute store result bossbar time_limit value run scoreboard players get #game.time.left timer
