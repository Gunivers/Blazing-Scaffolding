...
# EN
tellraw @a [{"translate":"blazing_scaffolding.sky_scrappers","color":"green","bold":true},{"text":"\n\n"},{"translate":"blazing_scaffolding.sky_scrappers_preset","color":"gray","bold":false},{"text":"\n---","color":"green","bold":true}]
