...
#Raise Lava
execute unless score LavaLevel global matches 1 as @e[type=area_effect_cloud,name="ScR_LavaLevel",limit=1] at @s run fill ~-7 ~-1 ~-7 ~7 ~-1 ~7 magma_block replace #scaffolding_rush:lavareplace
