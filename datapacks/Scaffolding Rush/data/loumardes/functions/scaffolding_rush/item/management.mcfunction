...
execute if score UseGravel options matches 1 as @a unless data entity @s Inventory[{id:"minecraft:gravel"}] run give @s gravel{CanPlaceOn:["minecraft:scaffolding"]}
