...
replaceitem entity @a[advancements={loumardes:scaffolding_rush/replenish/red_concrete_powder=true}] weapon.mainhand minecraft:red_concrete_powder{CanPlaceOn:["minecraft:scaffolding","#loumardes:lobby"],CanDestroy:["minecraft:scaffolding","#loumardes:lobby","#loumardes:tower"]}
