...
replaceitem entity @a[advancements={loumardes:scaffolding_rush/replenish/blue_concrete_powder=true}] weapon.mainhand minecraft:blue_concrete_powder{HideFlags:24,CanPlaceOn:["minecraft:scaffolding","#loumardes:notowerlobby"],CanDestroy:["minecraft:scaffolding","#loumardes:lobby","#loumardes:tower"]}
