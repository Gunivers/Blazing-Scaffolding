...
replaceitem entity @a[advancements={loumardes:scaffolding_rush/replenish/lime_concrete_powder=true}] weapon.mainhand minecraft:lime_concrete_powder{CanPlaceOn:["minecraft:scaffolding","#loumardes:notowerlobby"],CanDestroy:["minecraft:scaffolding","#loumardes:lobby","#loumardes:tower"]}
