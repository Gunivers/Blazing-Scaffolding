...
replaceitem entity @a[advancements={loumardes:scaffolding_rush/replenish/gravel=true}] weapon.mainhand minecraft:gravel{CanPlaceOn:["minecraft:scaffolding","#loumardes:lobby"],CanDestroy:["minecraft:scaffolding","#loumardes:lobby","#loumardes:tower"]}
