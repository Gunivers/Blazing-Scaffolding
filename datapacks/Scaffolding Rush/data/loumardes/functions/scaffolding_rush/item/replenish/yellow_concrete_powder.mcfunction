...
replaceitem entity @a[advancements={loumardes:scaffolding_rush/replenish/yellow_concrete_powder=true}] weapon.mainhand minecraft:yellow_concrete_powder{CanPlaceOn:["minecraft:scaffolding"]}
