...
tellraw @a ["",{"text":"[SR] ","color":"gold"},{"text":"The time to give back your villager has been set to ","color":"gray"},{"score":{"name":"VillagerRespawn","objective":"options"},"color":"gold"}]
