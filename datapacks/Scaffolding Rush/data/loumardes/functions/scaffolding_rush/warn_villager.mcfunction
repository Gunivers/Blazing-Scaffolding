...
execute if entity @e[type=villager,team=yellow] run title @a[team=yellow] actionbar ["",{"text":"Your villager is "},{"score":{"name":"@e[type=villager,team=yellow,limit=1]","objective":"YVillager"}},{"text":" blocks above lava"}]
execute if entity @e[type=villager,team=green] run title @a[team=green] actionbar ["",{"text":"Your villager is "},{"score":{"name":"@e[type=villager,team=green,limit=1]","objective":"YVillager"}},{"text":" blocks above lava"}]
