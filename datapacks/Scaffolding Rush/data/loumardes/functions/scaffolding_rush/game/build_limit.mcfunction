...
execute store result score @s global as @e[type=area_effect_cloud,name="ScR_BuildLimit"] at @s run fill ~-5 ~1 ~-5 ~5 ~1 ~5 minecraft:moving_piston replace minecraft:air
