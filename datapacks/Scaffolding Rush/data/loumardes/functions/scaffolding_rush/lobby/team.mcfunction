...
execute if score TeamNumber options matches 3.. unless entity @e[type=minecraft:area_effect_cloud,tag=lobbyTeam,name="Join Yellow"] run summon area_effect_cloud 5.0 4 2.0 {CustomName:'{"text":"Join Yellow","color":"yellow"}',Tags:["lobbyTeam"],CustomNameVisible: 1,Age: -2147483648, Duration: -1, WaitTime: -2147483648}
execute if score TeamNumber options matches 4.. unless entity @e[type=minecraft:area_effect_cloud,tag=lobbyTeam,name="Join Green"] run summon area_effect_cloud -4.0 4 2.0 {CustomName:'{"text":"Join Green","color":"green"}',Tags:["lobbyTeam"],CustomNameVisible: 1,Age: -2147483648, Duration: -1, WaitTime: -2147483648}
