...
execute as @e[type=minecraft:villager,tag=OnStand] at @s unless entity @e[type=minecraft:armor_stand,distance=..1] run function loumardes:scaffolding_rush/clean_kill
