...
execute if score PerformanceMode options matches 0 if score LavaCountdown global >= LavaSpeedTics options as @e[type=area_effect_cloud,name=ScR_LavaLevel] at @s run function loumardes:scaffolding_rush/rise_lava_globally
