...
execute if entity @s[team=red] at @e[type=villager,team=red] run tp @s ~ ~0.5 ~
execute if entity @s[team=blue] at @e[type=villager,team=blue] run tp @s ~ ~0.5 ~
execute if entity @s[team=yellow] at @e[type=villager,team=yellow] run tp @s ~0.5 ~ ~
execute if entity @s[team=green] at @e[type=villager,team=green] run tp @s ~ ~0.5 ~
