...
execute if entity @a[team=blue,gamemode=!spectator,limit=1] runscoreboard players add @a[team=blue] Win 1
...
execute if entity @a[team=green,gamemode=!spectator,limit=1] runscoreboard players add @a[team=green] Win 1
...
execute if entity @a[team=red,gamemode=!spectator,limit=1] runscoreboard players add @a[team=red] Win 1
...
execute if entity @a[team=yellow,gamemode=!spectator,limit=1] runscoreboard players add @a[team=yellow] Win 1
